class AXI_xtn extends uvm_sequence_item;
	...
	constraint write_align_1 {(awburst == 2'b10 && awsize == 1) -> awaddr % 2 == 0;}
	constraint write_align_2 {(awburst == 2'b10 && awsize == 2) -> awaddr % 4 == 0;}
	constraint write_align_3 {(awburst == 2'b10 && awsize == 3) -> awaddr % 8 == 0;}

	constraint read_align_1 {(arburst == 2'b10 && arsize == 1) -> araddr % 2 == 0;}
	constraint read_align_2 {(arburst == 2'b10 && arsize == 2) -> araddr % 4 == 0;}
	constraint read_align_3 {(arburst == 2'b10 && arsize == 3) -> araddr % 8 == 0;}
